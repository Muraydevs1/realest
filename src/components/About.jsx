        ...
        <div
         className='flex flex-col items-center justify-center container mx-auto pt-10 p-14 md:p-20 lg:px-32 w-full overflow-hidden' id='About'>
            ...
            <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20  '>
                <img src={assets.brand_img} className='w-full sm:w-1/2 max-w-lg' alt="Murray Investment residential development" width="886" height="956" loading="lazy" decoding="async" />
